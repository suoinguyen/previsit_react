...
declare class SiteApps {
    ...
    constructor(instance: PostHog);
    eventCollector(_eventName: string, eventPayload?: CaptureResult | undefined): void;
    init(): void;
