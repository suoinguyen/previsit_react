...
import { autocaptureCompatibleElements, getClassNames, getDirectAndNestedSpanText, getElementsChainString, getEventTarget, getSafeText, isAngularStyleAttr, isSensitiveElement, makeSafeText, shouldCaptureDomEvent, shouldCaptureElement, shouldCaptureValue, splitClassString, } from './autocapture-utils';
...
export function autocapturePropertiesForElement(target, _a) {
    var _b, _c, _d, _e;
    ...
    if (href) {
        ...
        var hrefHost = (_b = convertToURL(href)) === null || _b === void 0 ? void 0 : _b.host;
    ...
    Autocapture.prototype._captureEvent = function (e, eventName) {
        ...
        if (target &&
            ...
            if (eventName === COPY_AUTOCAPTURE_EVENT) {
                ...
                var selectedContent = makeSafeText((_b = window === null || window === void 0 ? void 0 : window.getSelection()) === null || _b === void 0 ? void 0 : _b.toString());
