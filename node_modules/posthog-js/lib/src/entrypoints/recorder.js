...
var exposesServerTiming = function (event) {
    return !isNull(event) && (event.entryType === 'navigation' || event.entryType === 'resource');
};
...
assignableWindow.__PosthogExtensions__.rrwebPlugins = { getRecordConsolePlugin: getRecordConsolePlugin, getRecordNetworkPlugin: getRecordNetworkPlugin };
...
assignableWindow.rrwebConsoleRecord = { getRecordConsolePlugin: getRecordConsolePlugin };
