...
import { isArray, isEmptyObject, isEmptyString, isFunction, isKnownUnsafeEditableEvent, isNullish, isNumber, isObject, isString, isUndefined, } from './utils/type-utils';
...
var PostHog = /** @class */ (function () {
    ...
    PostHog.prototype._init = function (token, config, name) {
        ...
        (_g = window === null || window === void 0 ? void 0 : window.addEventListener) === null || _g === void 0 ? void 0 : _g.call(window, 'onpagehide' in self ? 'pagehide' : 'unload', this._handle_unload.bind(this));
    ...
    PostHog.prototype._afterDecideResponse = function (response) {
        ...
        (_b = this.siteApps) === null || _b === void 0 ? void 0 : _b.afterDecideResponse(response);
        (_c = this.sessionRecording) === null || _c === void 0 ? void 0 : _c.afterDecideResponse(response);
        (_d = this.autocapture) === null || _d === void 0 ? void 0 : _d.afterDecideResponse(response);
        (_e = this.heatmaps) === null || _e === void 0 ? void 0 : _e.afterDecideResponse(response);
        (_f = this.experiments) === null || _f === void 0 ? void 0 : _f.afterDecideResponse(response);
        (_g = this.surveys) === null || _g === void 0 ? void 0 : _g.afterDecideResponse(response);
        (_h = this.webVitalsAutocapture) === null || _h === void 0 ? void 0 : _h.afterDecideResponse(response);
        (_j = this.exceptionObserver) === null || _j === void 0 ? void 0 : _j.afterDecideResponse(response);
        (_k = this.deadClicksAutocapture) === null || _k === void 0 ? void 0 : _k.afterDecideResponse(response);
    };
