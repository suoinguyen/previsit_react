...
export var jsonStringify = function (data, space) {
...
var encodePostData = function (_a) {
    ...
    if (compression === Compression.GZipJS) {
        var gzipData = gzipSync(strToU8(jsonStringify(data)), { mtime: 0 });
    ...
    if (compression === Compression.Base64) {
        var b64data = _base64Encode(jsonStringify(data));
    ...
    var jsonBody = jsonStringify(data);
    return {
