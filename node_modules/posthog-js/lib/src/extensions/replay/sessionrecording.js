...
var SessionRecording = /** @class */ (function () {
    ...
    SessionRecording.prototype.startIfEnabledOrStop = function (startReason) {
        ...
        if (this.isRecordingEnabled) {
            ...
            if (isNullish(this._removePageViewCaptureHook)) {
                ...
                this._removePageViewCaptureHook = this.instance.on('eventCaptured', function (event) {
        ...
        if (this.instance.persistence) {
            ...
            var persistResponse = function () {
                ...
                persistence_1.register((_a = {},
                    ...
                    _a[SESSION_RECORDING_SCRIPT_CONFIG] = (_j = response.sessionRecording) === null || _j === void 0 ? void 0 : _j.scriptConfig,
                    _a));
            };
            persistResponse();
    ...
    SessionRecording.prototype._startCapture = function (startReason) {
        ...
        if (!this.rrwebRecord) {
            (_b = (_a = assignableWindow.__PosthogExtensions__) === null || _a === void 0 ? void 0 : _a.loadExternalDependency) === null || _b === void 0 ? void 0 : _b.call(_a, this.instance, this.scriptName, function (err) {
                if (err) {
    ...
    Object.defineProperty(SessionRecording.prototype, "scriptName", {
        get: function () {
            var _a, _b, _c;
            return (((_c = (_b = (_a = this.instance) === null || _a === void 0 ? void 0 : _a.persistence) === null || _b === void 0 ? void 0 : _b.get_property(SESSION_RECORDING_SCRIPT_CONFIG)) === null || _c === void 0 ? void 0 : _c.script) || 'recorder');
        },
        enumerable: false,
        configurable: true
    });
